  ...
  render() {
    return (
      <div className={classes.landingPageCtn}>
        ...
        <main>
          <Flexbox flexWrap="wrap" className={`${classes.introCtn} ${classes.layerCtn}`}>
          ...
          <Flexbox flexWrap="wrap" className={`${classes.aboutCtn} ${classes.layerCtn}`}>
          ...
          <Flexbox background={theme.color.primary} flexWrap="wrap" className={`${classes.bottomCtn} ${classes.layerCtn}`}>
            <Heading level={4}>
