      ...
      <SignUpTemplate>
        ...
        <div className={classes.content}>
          ...
          <div className={classes.bottomCtn}>
            <Heading level={4}>
              Your availablity is visible wherever your profile photo shows across the application
            </Heading>

            <Heading level={5} color="accent1">
              Does a week seem like the wrong timeframe for your type of work? You&apos;ll be able to change this in your settings soon.
            </Heading>

            <Link to="/profile"><Button>Gotcha, Show me my profile</Button></Link>
          </div>
        </div>
      </SignUpTemplate>
    )
